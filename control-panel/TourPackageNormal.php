...
class TourPackageNormal {
    ...
    public function delete() {
        ...
        unlink(Helper::getSitePath() . "upload/normal-tour-package/" . $this->image_name);
    ...
    public function deleteTourDates() {
        ...
        foreach ($alldates as $date) {
            ...
            unlink(Helper::getSitePath() . "upload/normal-tour-package/gallery/" . $IMG);
            unlink(Helper::getSitePath() . "upload/normal-tour-package/thumb/" . $IMG);
